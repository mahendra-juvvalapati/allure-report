...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Yes' })
    9 × locator resolved to <button type="button" ng-transclude="" disabled="disabled" ng-disabled="__showProgress" class="md-button md-ink-ripple" ng-click="__showProgressBar(); __callback()">…</button>
      ...
      - generic [ref=e239]:
        - generic [ref=e241]:
          - img [ref=e243]:
            - img
          - generic [ref=e244]:
            - generic [ref=e246]: "Risk: Risk 1778777574860"
        ...
        - generic [ref=e257]:
          ...
          - generic [ref=e258]:
            ...
            - tabpanel "Dialogue" [ref=e360]:
              - button "inpreparation Questionnaire 1778777574860 Card image %" [ref=e370] [cursor=pointer]:
                - generic [ref=e371]:
                  - img "inpreparation" [ref=e373]
                  - generic "Questionnaire 1778777574860" [ref=e374]:
                    - generic [ref=e375]: Questionnaire 1778777574860
