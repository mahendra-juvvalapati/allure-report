...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Yes' })
    6 × locator resolved to <button type="button" ng-transclude="" disabled="disabled" ng-disabled="__showProgress" class="md-button md-ink-ripple" ng-click="__showProgressBar(); __callback()">…</button>
        ...
        - generic [ref=e241]:
          - generic [ref=e243]:
            - img [ref=e245]:
              - img
            - generic [ref=e246]:
              - generic [ref=e248]: "Risk: Risk 1779441625032"
          ...
          - generic [ref=e259]:
            ...
            - generic [ref=e260]:
              ...
              - tabpanel "Dialogue" [ref=e356]:
                - button "inpreparation Questionnaire_FC_024 1779441625032 Card image %" [ref=e366] [cursor=pointer]:
                  - generic [ref=e367]:
                    - img "inpreparation" [ref=e369]
                    - generic "Questionnaire_FC_024 1779441625032" [ref=e370]:
                      - generic [ref=e371]: Questionnaire_FC_024 1779441625032
