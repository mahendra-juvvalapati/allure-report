...
Call log:
  ...
  - waiting for getByTestId('Add')
    3 × locator resolved to <button disabled tabindex="-1" type="button" name="create" data-test-id="Add" data-testid="save" data-v-e21a183a-s="" aria-disabled="true" class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle text-primary disabled items-center">…</button>
    ...
    - generic [ref=e9]:
      ...
      - generic [ref=e218]:
        - generic [ref=e220]:
          ...
          - generic [ref=e256]: Questionnaire_1779350598394
        - generic [ref=e258]:
          - toolbar [ref=e260]:
            - tablist [ref=e261]:
              - generic [ref=e262]:
                      ...
                      - generic [ref=e312]:
                        ...
                        - list [ref=e323]:
                          ...
                          - listitem [ref=e357]:
                            ...
                            - generic [ref=e361]: Always
                            - switch [checked] [ref=e364] [cursor=pointer]
                          - listitem [ref=e368]:
                            - generic [ref=e370]: list
                            - generic [ref=e372]: nonConfirmity
                            - switch [checked] [ref=e375] [cursor=pointer]
                      - generic [ref=e380]:
                        - generic [ref=e381]:
                          - generic [ref=e382]:
                            - generic [ref=e388]:
                              - textbox "Condition Name *" [ref=e389]: nonConfirmity
