...
- main:
  ...
  - tabpanel "Dialogue":
    - button "inpreparation Copy - Questionnaire_1779287722864 Card image %":
      ...
      - img "Card image"
      - text: "%"
    - button "executer Questionnaire 1780050080210 Card image %":
      - img "executer"
      - text: Questionnaire 1780050080210
      - img "Card image"
      - text: "%"
- iframe
- dialog:
  - banner:
    ...
    - listitem:
      ...
      - button
  - main:
    - text: "Risk : Risk 1780050080210 Date and time Questions Date and time Question"
    - textbox:
      - /placeholder: Enter answer here
      - text: 29-05-2026 10:33:48
