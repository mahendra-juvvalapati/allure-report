...
- main:
  ...
  - button "Publish"
  - button
  - text: Questionnaire_1780294433185
  - toolbar:
    - tablist:
      - tab "Settings"
  ...
  - tabpanel:
    - tabpanel:
      - toolbar:
        - text: (2-2) Page name 2
        - combobox "(2-2) Page name 2 Selected questionnaire page": (2-2) Page name 2
        - text: Selected questionnaire page
        - button
      - textbox "Page Title": Page name 2
      - text: Page Title
      - checkbox "Disable"
      - alert:
        - button
