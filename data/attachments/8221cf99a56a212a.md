...
Call log:
  - waiting for getByText('DATE AND OR TIME Question').last()
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <div tabindex="-1" aria-hidden="true" class="q-dialog__backdrop fixed-full"></div> from <div class="fic-pluto" id="q-portal--dialog--5">…</div> subtree intercepts pointer events
    ...
    21 × waiting for element to be visible, enabled and stable
       ...
       - scrolling into view if needed
       - done scrolling
       - <input type="text" tabindex="0" name="shortName" list="shortName" autocomplete="off" data-test-id="shortName" can-trim-on-change-done="true" class="q-field__native q-placeholder" id="f_3c4f9b63-97f8-4171-934d-97dc852ec295"/> from <div class="fic-pluto" id="q-portal--dialog--5">…</div> subtree intercepts pointer events
     - retrying click action
       - waiting 500ms
    ...
    - generic [ref=e9]:
      ...
      - generic [ref=e218]:
        - generic [ref=e220]:
          ...
          - generic [ref=e256]: Questionnaire_1779347002217
        - generic [ref=e258]:
          - toolbar [ref=e260]:
            - tablist [ref=e261]:
              - generic [ref=e262]:
                  ...
                  - generic [ref=e306]:
                    ...
                    - alert [ref=e327]:
                      - button [ref=e329] [cursor=pointer]:
                        - img [ref=e331]: event
                      - generic [ref=e334]: DATE AND OR TIME Question
                      - generic [ref=e335]:
      ...
      - generic [ref=e410]:
        ...
        - generic [ref=e421]:
          - toolbar [ref=e423]:
            - tablist [ref=e424]:
              - generic [ref=e425]:
                - tab "Question" [selected] [ref=e426] [cursor=pointer]:
                  - generic [ref=e428]: Question
                - tab "settings" [ref=e430] [cursor=pointer]:
                  - generic [ref=e432]: settings
                - tab "Explanation" [ref=e434] [cursor=pointer]:
                  - generic [ref=e436]: Explanation
          - tabpanel [ref=e440]:
            - tabpanel [ref=e441]:
              - generic [ref=e442]:
                - generic [ref=e449]:
                  - textbox "Question number" [ref=e450]
                  - generic: Question number
                - generic [ref=e457]:
                  - textbox "Question" [ref=e458]
                  - generic: Question
                - checkbox "Mandatory" [ref=e461] [cursor=pointer]:
                  - img [ref=e464]
                  - generic [ref=e466]: Mandatory
                - generic [ref=e473]:
                  - textbox "Calculation variable" [ref=e474]
                  - generic: Calculation variable
                - generic [ref=e481]:
                  - textbox "Variable" [ref=e482]
                  - generic: Variable
                - checkbox "Read Only" [ref=e485] [cursor=pointer]:
                  - img [ref=e488]
                  - generic [ref=e490]: Read Only
                - checkbox "Add documents as evidence" [ref=e493] [cursor=pointer]:
                  - img [ref=e496]
                  - generic [ref=e498]: Add documents as evidence
                - checkbox "Documentation when notes" [ref=e501] [cursor=pointer]:
                  - img [ref=e504]
                  - generic [ref=e506]: Documentation when notes
        - button "CLOSE" [ref=e509] [cursor=pointer]:
          - generic [ref=e511]: CLOSE
```
