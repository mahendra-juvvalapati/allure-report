...
- Name: E2E_Tests/FC036_questionnaire.spec.js >> FC_036_Questionnaire Flow >> Configure questionnaire with 'Questionnaire email text for invitation' and verify 'Show finish page' action is executed when Question condition is triggered on 'Completing the page' and check Questionnaire 'Enable' action
- Location: tests/E2E_Tests/FC036_questionnaire.spec.js:37:9
...
Locator: getByText('Questionnaire 1780058668423 Link').getByRole('checkbox', { name: 'ql._id' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('Questionnaire 1780058668423 Link').getByRole('checkbox', { name: 'ql._id' })
...
- dialog "wef":
  ...
  - textbox "Enter search": Questionnaire 1780058668423
  - text: search
  - progressbar
  - button "Cancel"
  - button "OK" [disabled]
