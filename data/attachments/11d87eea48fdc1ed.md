...
- main:
  ...
  - tabpanel "Risks":
    - grid:
      - button "Grid Menu": more_vert
      - rowgroup:
        - row
      - rowgroup:
        - row
      - rowgroup:
        - row "Invitation Groups Sort None Type Sort None Name Sort None Item Number Sort None Status Sort None Added By Sort None Date Added Sort None":
          - columnheader "Invitation Groups Sort None":
            - columnheader "Invitation Groups Sort None":
              - button "Invitation Groups"
          - columnheader "Type Sort None":
            - columnheader "Type Sort None":
              - button "Type"
          - columnheader "Name Sort None":
            - columnheader "Name Sort None":
              - button "Name"
          - columnheader "Item Number Sort None":
            - columnheader "Item Number Sort None":
              - button "Item Number"
          - columnheader "Status Sort None":
            - columnheader "Status Sort None":
              - button "Status"
          - columnheader "Added By Sort None":
            - columnheader "Added By Sort None":
              - button "Added By"
          - columnheader "Date Added Sort None":
            - columnheader "Date Added Sort None":
              - button "Date Added"
      - rowgroup:
        - row "Risk 4134 QUALITLABSHYD.RIS.0000021 NEW Mahendra J 03-06-2026":
          - gridcell
          - gridcell
          - gridcell "Risk 4134"
          - gridcell "QUALITLABSHYD.RIS.0000021"
          - gridcell "NEW"
          - gridcell "Mahendra J"
          - gridcell "03-06-2026"
  - button
