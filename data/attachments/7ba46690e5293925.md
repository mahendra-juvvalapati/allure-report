...
Locator: getByText('Questionnaire 1778568763183 Link').getByRole('checkbox', { name: 'ql._id' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('Questionnaire 1778568763183 Link').getByRole('checkbox', { name: 'ql._id' })
      ...
      - generic [ref=e243]:
        - generic [ref=e245]:
          - img [ref=e247]:
            - img
          - generic [ref=e248]:
            - generic [ref=e250]: "Risk: Risk 1778568763183"
      ...
      - generic [ref=e385]:
        ...
        - button "select country QA Automation" [ref=e386]:
          - generic [ref=e387]:
            ...
            - generic [ref=e389]: ▼
      - generic [ref=e390]:
        - textbox "Enter search" [ref=e393]: Questionnaire 1778568763183
