...
Locator: locator('[data-test-mo-question-name="What is your name?"]')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('[data-test-mo-question-name="What is your name?"]')
...
- main:
  ...
  - tablist "Use the left and right arrow keys to navigate between tabs":
    ...
    - tab "Risks"
  - tabpanel "Dialogue":
    - button "inpreparation Questionnaire 1780041717249 Card image %":
      - img "inpreparation"
      - text: Questionnaire 1780041717249
      - img "Card image"
      - text: "%"
- iframe
- dialog:
...
```ts
  30  | test.describe('FC_013_Questionnaire Flow', () => {
