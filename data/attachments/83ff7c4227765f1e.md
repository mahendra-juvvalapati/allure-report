...
Call log:
  ...
  - waiting for locator('span').filter({ hasText: 'This is the last page of the questionnaire. Not all pages are completed. Do you want to finish the questionnaire and complete all pages?' })
    24 × locator resolved to <span data-v-03c9c592="">This is the last page of the questionnaire. Not a…</span>
...
> 114 |     await expect(element).not.toBeVisible();
  ...
  205 |     const cell = rowLocator.locator('[role="gridcell"]').nth(colIndex);
  206 |     await expect(cell).toContainText(expectedValue);
  207 |   }
  208 | 
