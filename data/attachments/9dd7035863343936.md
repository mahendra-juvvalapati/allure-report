...
- Name: questionCondition.spec.ts >> Question Condition Tests >> TC_QC_033-Verify 'Generate Report And Send To Service' action can be created successfully in question conditions
- Location: tests/questionCondition.spec.ts:315:9
...
- generic [ref=e1]:
  ...
  - generic [ref=e7]:
    ...
    - generic [ref=e216]:
      - generic [ref=e218]:
        ...
        - generic [ref=e254]: Questionnaire_1778606603144
      - generic [ref=e256]:
        - toolbar [ref=e258]:
          - tablist [ref=e259]:
            - generic [ref=e260]:
  ...
  - generic:
    - dialog:
      - generic [ref=e1430]:
        - toolbar [ref=e1432]:
          - generic [ref=e1433]: Select Template
          - button [ref=e1435] [cursor=pointer]:
            - img [ref=e1437]: close
        - generic [ref=e1443]:
          - generic [ref=e1444]:
            - combobox "Select service *" [expanded] [active] [ref=e1446] [cursor=pointer]
            - generic:
              - generic: Select service *
          - img [ref=e1448]
        - generic [ref=e1451]:
          - button "Cancel" [ref=e1452] [cursor=pointer]:
            - generic [ref=e1454]: Cancel
          - button "Okay" [disabled]:
            - generic:
              - generic: Okay
  - listbox [ref=e1455]:
    - listitem [ref=e1456]:
      - generic [ref=e1458]: No results
```
