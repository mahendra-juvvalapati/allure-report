...
Error: strict mode violation: getByText('LINK TAB INDICATOR') resolved to 2 elements:
    ...
    2) <span flex="" class="ng-binding flex"> LINK TAB INDICATOR </span> aka locator('#dialogContent_1826').getByText('LINK TAB INDICATOR')

Call log:
  - Expect "toBeVisible" with timeout 15000ms
  - waiting for getByText('LINK TAB INDICATOR')
    - locator resolved to <label class="text-capitalize text-caption">LINK TAB INDICATOR</label>
      ...
      - generic [ref=e247]:
        - generic [ref=e249]:
          - img [ref=e251]:
            - img
          - generic [ref=e252]:
            - generic [ref=e254]: "Risk: Risk 1778667371174"
                ...
                - rowgroup [ref=e427]:
                  - generic [ref=e429]:
                    ...
                    - gridcell [ref=e434] [cursor=pointer]:
                      - generic [ref=e435]: Risk 1365
                    - gridcell [ref=e436] [cursor=pointer]:
                      - generic [ref=e437]: QUALITLABSHYD.RIS.0001000
