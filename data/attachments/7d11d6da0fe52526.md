...
Locator:  locator('span').filter({ hasText: 'This is the last page of the questionnaire. Not all pages are completed. Do you want to finish the questionnaire and complete all pages?' })
...
Call log:
  ...
  - waiting for locator('span').filter({ hasText: 'This is the last page of the questionnaire. Not all pages are completed. Do you want to finish the questionnaire and complete all pages?' })
    29 × locator resolved to <span data-v-03c9c592="">This is the last page of the questionnaire. Not a…</span>
       - unexpected value "visible"

```

```yaml
- text: This is the last page of the questionnaire. Not all pages are completed. Do you want to finish the questionnaire and complete all pages?
```
...
> 114 |     await expect(element).not.toBeVisible();
  ...
  210 |     if (percentage <= 0) {
  211 |       throw new Error('Zoom percentage must be greater than 0');
  212 |     }
  213 | 
  214 |     await this.page.evaluate((zoom) => {
```