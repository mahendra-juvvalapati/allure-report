...
Locator: getByText('Test_1780042514358 Link').getByRole('checkbox', { name: 'ql._id' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('Test_1780042514358 Link').getByRole('checkbox', { name: 'ql._id' })
...
- dialog "wef":
  ...
  - textbox "Enter search": Test_1780042514358
  - text: search
  - progressbar
  - button "Cancel"
  - button "OK" [disabled]
