...
- main:
  ...
  - button "Publish"
  - button
  - text: Questionnaire 1780552806533
  - toolbar:
    - tablist:
      - tab "Settings"
  ...
  - tabpanel:
    - tabpanel:
      - toolbar:
        - text: (1-1) Matrix questions
        - combobox "(1-1) Matrix questions Selected questionnaire page": (1-1) Matrix questions
        - text: Selected questionnaire page
        - button
      - textbox "Page Title": Matrix questions
      - text: Page Title
      - checkbox "Disable"
      - alert:
        - button
...
- dialog:
  - toolbar:
    ...
    - button
  - textbox "Answer set name *": Ratings
  - text: Answer set name *
  - textbox "Description": Rating scale
