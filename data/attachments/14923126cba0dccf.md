...
Locator: locator('[role="option"]').filter({ hasText: 'File/Picture questions' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('[role="option"]').filter({ hasText: 'File/Picture questions' })
...
- main:
  ...
  - button "Publish"
  - button
  - text: Questionnaire 1780567577746
  - toolbar:
    - tablist:
      - tab "Settings"
  ...
  - tabpanel:
    - tabpanel:
      - toolbar:
        - text: (1-1) Empty Page
        - combobox "(1-1) Empty Page Selected questionnaire page" [expanded]: (1-1) Empty Page
        - text: Selected questionnaire page
        - button
      - textbox "Page Title": Empty Page
      - text: Page Title
      - checkbox "Disable"
      - alert:
        - button
        - text: Upload File/Picture 1
        - button
        - checkbox [checked]
        - button
        - button
...
- iframe
- listbox:
  - option "(1-1) Empty Page" [selected]
```
