...
Locator: getByTestId('questionName')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByTestId('questionName')
...
- main:
  ...
  - button "Publish"
  - button
  - text: Questionnaire_1780069273420
  - toolbar:
    - tablist:
      - tab "Settings"
  ...
  - tabpanel:
    - tabpanel:
      ...
      - alert:
        - button
        - text: MANAGEABLEOBJECT Question
        - button
        - checkbox [checked]
        - button
        - button
