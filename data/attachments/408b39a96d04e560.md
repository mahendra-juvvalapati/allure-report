...
Locator: getByRole('option', { name: 'Key Performance Indicator (KPI)', exact: true })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('option', { name: 'Key Performance Indicator (KPI)', exact: true })
  ...
  - generic [ref=e7]:
    ...
    - generic [ref=e216]:
      - generic [ref=e218]:
        ...
        - generic [ref=e254]: Questionnaire_1778753260486
      - generic [ref=e256]:
        - toolbar [ref=e258]:
          - tablist [ref=e259]:
            - generic [ref=e260]:
