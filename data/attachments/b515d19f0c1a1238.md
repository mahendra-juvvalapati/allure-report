...
Call log:
  - waiting for locator('[data-testid="Questionnaire_FC_024 1779358625962"]')
    - locator resolved to <md-card tabindex="0" role="button" class="cursor moQCards bgWhite colorBlack _md" data-testid="Questionnaire_FC_024 1779358625962" ng-click="moquestionnaire.data.manageQuestionnaire ? '' : moquestionnaire.goToRealQuestionnaire(q._id)">…</md-card>
        ...
        - generic [ref=e241]:
          - generic [ref=e243]:
            - img [ref=e245]:
              - img
            - generic [ref=e246]:
              - generic [ref=e248]: "Risk: Risk 1779358625962"
          ...
          - generic [ref=e259]:
            ...
            - generic [ref=e260]:
              ...
              - tabpanel "Dialogue" [ref=e356]:
                - button "inpreparation Questionnaire_FC_024 1779358625962 Card image %" [ref=e366] [cursor=pointer]:
                  - generic [ref=e367]:
                    - img "inpreparation" [ref=e369]
                    - generic "Questionnaire_FC_024 1779358625962" [ref=e370]:
                      - generic [ref=e371]: Questionnaire_FC_024 1779358625962
