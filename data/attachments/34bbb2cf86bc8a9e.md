...
- Name: E2E_Tests/FC026_questionnaire.spec.ts >> FC_026_Questionnaire Flow >> Configure questionnaire with 'No Settings' and verify 'Set Answers to' action is executed when Question condition is triggered on 'Change a question' and check Questionnaire 'Set state of linked item' action
- Location: tests/E2E_Tests/FC026_questionnaire.spec.ts:37:9
...
- main:
  ...
  - button
  - button
  - text: QA Automation There are no Dashboards yet!
- iframe
