...
- main:
  ...
  - tablist "Use the left and right arrow keys to navigate between tabs":
    ...
    - tab "Risks"
  - tabpanel "Dialogue":
    - button "executer Questionnaire 1780069428187 Card image %":
      - img "executer"
      - text: Questionnaire 1780069428187
      - img "Card image"
      - text: "%"
- iframe
- dialog:
  - banner:
    ...
    - listitem:
      ...
      - text: Go to page |
  - main:
    - text: "Risk : Risk 1780069428187 Attributes questions"
    - listitem:
