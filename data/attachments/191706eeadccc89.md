...
Locator: getByText('Questionnaire8454 Link').getByRole('checkbox', { name: 'ql._id' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('Questionnaire8454 Link').getByRole('checkbox', { name: 'ql._id' })
...
- dialog "wef":
  ...
  - textbox "Enter search": Questionnaire8454
  - text: search
  - progressbar
  - button "Cancel"
  - button "OK" [disabled]
