...
- main:
  ...
  - button "Publish"
  - button
  - text: Questionnaire 1780067207453
  - toolbar:
    - tablist:
      - tab "Settings"
      - tab "Questionnaire"
    ...
    - tabpanel:
      ...
      - tabpanel:
        - tabpanel:
          ...
          - text: Question
          - combobox "Question Condition On"
          - text: Condition On short and long Text Questions
          - combobox "short and long Text Questions Page number"
          - text: Page number
          - combobox "Where" [expanded]
          - text: Where
          - combobox "Operator"
          - text: Operator
          - combobox "data"
...
- iframe
- listbox:
  - option "Text Question with long text"
```
