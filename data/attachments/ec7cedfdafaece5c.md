...
- Name: questionnaireIndicators.spec.ts >> Indicators Tab Tests >> TC_IN_011-Verify perspective dropdown contains all  6 options
- Location: tests/questionnaireIndicators.spec.ts:156:9
...
Locator: getByTestId('perspective').last()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByTestId('perspective').last()
  ...
  - generic [ref=e7]:
    ...
    - generic [ref=e216]:
      - generic [ref=e218]:
        ...
        - generic [ref=e254]: Questionnaire_1778840147622
      - generic [ref=e256]:
        - toolbar [ref=e258]:
          - tablist [ref=e259]:
            - generic [ref=e260]:
