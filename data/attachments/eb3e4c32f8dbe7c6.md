...
- Name: E2E_Tests/FC017_questionnaire.spec.ts >> FC_017_Questionnaire Flow >> Configure questionnaire with 'External user can finish the questionnaire' and verify 'Show finish page' action is executed when Question condition is triggered on 'Change a question' and check Questionnaire 'Disable Finishing of a questionnaire' action
- Location: tests/E2E_Tests/FC017_questionnaire.spec.ts:38:9
