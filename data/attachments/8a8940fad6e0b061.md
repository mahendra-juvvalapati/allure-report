...
Call log:
  ...
  - attempting click action
    ...
    - done scrolling
    - <div data-v-73a3790a="" data-v-e21a183a-s="" class="text-center q-ma-auto text-primary">…</div> from <md-toolbar class="md-hue-3  dashboard-left-nav contentCenterAlign beam1 beam2 _md-toolbar-transitions" ng-class="{ contentCenterAlign: (($mdMedia('gt-md')) && !(isExternalUser || isGroupedLink) && hasSideNav), 'beam1': prDash, 'beam2': acDash,'bg-accent': acDashColor, 'bg-primary': prDashColor}">…</md-toolbar> subtree intercepts pointer events
  - retrying click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <i class="material-icons ng-scope">build</i> from <button type="button" ng-transclude="" aria-hidden="false" ng-show="showManageQuestionnaires()" class="md-icon-button dropdown md-button md-ink-ripple">…</button> subtree intercepts pointer events
  - retrying click action
    - waiting 20ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
  ...
  2 × retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <div data-v-73a3790a="" data-v-e21a183a-s="" class="company-name-cls text-capitalize q-pt-sm q-pb-sm">QA Automation</div> from <md-toolbar class="md-hue-3  dashboard-left-nav contentCenterAlign beam1 beam2 _md-toolbar-transitions" ng-class="{ contentCenterAlign: (($mdMedia('gt-md')) && !(isExternalUser || isGroupedLink) && hasSideNav), 'beam1': prDash, 'beam2': acDash,'bg-accent': acDashColor, 'bg-primary': prDashColor}">…</md-toolbar> subtree intercepts pointer events
...
- generic [active] [ref=e1]:
          ...
          - generic [ref=e221]:
            - generic [ref=e227]:
              - button [ref=e229] [cursor=pointer]:
                - img [ref=e231]: arrow_back
              - generic [ref=e233]:
                - generic [ref=e235] [cursor=pointer]: Qualitlabs
                - generic [ref=e237]: keyboard_arrow_right
                - generic [ref=e239] [cursor=pointer]: Knowledge database
            - generic [ref=e241]:
              - button [ref=e242] [cursor=pointer]:
                - img [ref=e244]: build
              - button [ref=e245] [cursor=pointer]:
                - img [ref=e247]: settings
          - generic [ref=e248]: QA Automation
        - generic [ref=e250]:
          - img [ref=e252]
          - generic [ref=e253]: There are no Dashboards yet!
  - iframe [ref=e255]:
    - generic [active]:
      - generic:
        - text:  
  ...
  - generic [ref=e256]:
    - generic [ref=e257]: weetje
    - generic [ref=e258]: Dubbelklik op item
    - img [ref=e259]
  - generic:
