...
Call log:
  ...
  - waiting for locator('.ag-center-cols-container [role="row"]').first().locator('[col-id="owner"]')
    34 × locator resolved to <div comp-id="424" col-id="owner" role="gridcell" aria-colindex="5" class="ag-cell-value ag-cell ag-cell-not-inline-editing ag-cell-normal-height">Mahendra</div>
