...
Locator: getByRole('textbox', { name: 'Enter search' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('textbox', { name: 'Enter search' })
      ...
      - generic [ref=e212]:
        - generic [ref=e214]:
          - generic [ref=e215]:
            ...
            - generic [ref=e229]:
              - button "variables" [ref=e230] [cursor=pointer]:
                - img [ref=e231]:
                  - generic [ref=e232]: featured_play_list
              - button "clear" [ref=e233] [cursor=pointer]:
                - img [ref=e234]:
                  - generic [ref=e235]: clear
            - generic [ref=e236]:
              - button "add mo to projects" [ref=e238] [cursor=pointer]:
                - img [ref=e239]:
                  - img
        ...
        - generic [ref=e244]:
          - generic [ref=e246]:
            - img [ref=e248]:
              - img
            - generic [ref=e249]:
              - generic [ref=e251]: "Risk: Risk_1779441512429"
              - button "Copy item" [ref=e253] [cursor=pointer]:
                - img "copy item" [ref=e254]: file_copy
              - button "Close current version and start new version" [ref=e255] [cursor=pointer]:
                - img "quick-version" [ref=e256]:
                  - img
              - generic [ref=e257]:
              ...
              - generic [ref=e264]:
                ...
                - button "Next Page" [ref=e268] [cursor=pointer]:
                  - img [ref=e269]:
                    - img
                - generic [ref=e270]:
                  - tablist "Use the left and right arrow keys to navigate between tabs" [ref=e271]:
                    - tab "Gross risk" [ref=e272] [cursor=pointer]:
                      - generic [ref=e274]: Gross risk
                    - tab "Net risk" [ref=e275] [cursor=pointer]:
                      - generic [ref=e277]: Net risk
                    - tab "Bowtie" [ref=e278] [cursor=pointer]:
                      - generic [ref=e280]: Bowtie
                    - tab "Measures" [ref=e281] [cursor=pointer]:
                      - generic [ref=e283]: Measures
                    - tab "Kritieke Bedrijfsfuncties" [ref=e284] [cursor=pointer]:
                      - generic [ref=e286]: Kritieke Bedrijfsfuncties
                    - tab "Dialogue" [selected] [ref=e287]:
                      - generic [ref=e289]: Dialogue
                    - tab "Chat" [ref=e290] [cursor=pointer]:
                      - generic [ref=e292]: Chat
                    - tab "Information systems" [ref=e293] [cursor=pointer]:
                      - generic [ref=e295]: Information systems
                    - tab "Related" [ref=e296] [cursor=pointer]:
                      - generic [ref=e298]: Related
                    - tab "Tasks" [ref=e299] [cursor=pointer]:
                      - generic [ref=e301]: Tasks
                    - tab "Key Indicators" [ref=e302] [cursor=pointer]:
                      - generic [ref=e304]: Key Indicators
                    - tab "History" [ref=e305] [cursor=pointer]:
                      - generic [ref=e307]: History
                    - tab "mo data" [ref=e308] [cursor=pointer]:
                      - generic [ref=e310]: mo data
                  ...
                  - generic [ref=e315]:
                    ...
                    - generic [ref=e357] [cursor=pointer]: Risks
              - tabpanel "Dialogue" [ref=e359]:
                - button "inpreparation Test_1779441512429 more_vert Card image q.questionnaireEnable" [ref=e369] [cursor=pointer]:
                  - generic [ref=e370]:
                    - img "inpreparation" [ref=e372]
                    - generic "Test_1779441512429" [ref=e373]:
                      - generic [ref=e374]: Test_1779441512429
                    - button "more_vert" [ref=e376]
                  - img "Card image" [ref=e378]
                  - generic [ref=e380]:
                    - button [ref=e381]:
                      - img
                    - checkbox "q.questionnaireEnable" [checked] [ref=e382]
                    - button [ref=e385]:
                      - img
        - button "add" [ref=e386] [cursor=pointer]:
