...
- main:
  ...
  - button "Publish"
  - button
  - text: Questionnaire 1780067758223
  - toolbar:
    - tablist:
      - tab "Settings"
      - tab "Questionnaire" [selected]
  ...
  - tabpanel:
    - tabpanel:
      - toolbar:
        - text: (1-1) Number questions
        - combobox "(1-1) Number questions Selected questionnaire page": (1-1) Number questions
        - text: Selected questionnaire page
        - button
      - textbox "Page Title": Number questions
      - text: Page Title
      - checkbox "Disable"
      - alert:
        - button
        - text: NUMBER AMOUNT Question
        - button
        - checkbox [checked]
        - button
        - button
...
- dialog:
  - toolbar:
    - text: Answerset Settings
    - button
  - textbox "Answer set name *": Locations
  - text: Answer set name *
  - textbox "Description": Select your number from the slider
  - text: Description Answerset type Single use
  - switch
  - text: Multi use
  - button "Cancel"
  - button "Save"
