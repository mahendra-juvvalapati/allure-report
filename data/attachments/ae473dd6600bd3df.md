...
Locator: getByRole('button').filter({ hasText: /^add$/ })
Expected: visible
Timeout: 15000ms
      ...
      - generic [ref=e50]:
        ...
        - list [ref=e73]:
          ...
          - list [ref=e87]:
            ...
            - button "Risks" [active] [ref=e118] [cursor=pointer]:
              - img [ref=e119]:
                - img
        ...
        - generic [ref=e211]:
          - generic [ref=e217]:
            - button [ref=e219] [cursor=pointer]:
              - img [ref=e221]: arrow_back
            - generic [ref=e225] [cursor=pointer]: Qualitlabs
          - button [ref=e228] [cursor=pointer]:
            - img [ref=e230]: settings
        - generic [ref=e231]: QualiTlabs Hyd
      - generic [ref=e233]:
        - img [ref=e235]
        - generic [ref=e236]: There are no Dashboards yet!
  - iframe [ref=e238]:
    - generic [active]:
      - generic:
        - text:  
