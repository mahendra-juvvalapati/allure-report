...
- Name: E2E_Tests/FC043_questionnaire.spec.ts >> FC_043_Questionnaire Flow >> Configure questionnaire with 'External user can finish the questionnaire' and verify 'Lock' action is executed when Question condition is triggered on 'Entering the questionnaire the first time' and check Questionnaire 'Set state of linked item' action
- Location: tests/E2E_Tests/FC043_questionnaire.spec.ts:31:9
...
- main:
  ...
  - grid:
    ...
    - rowgroup
- iframe
- text: weetje AI Adviseurs Team beschikbaar
- img
```
