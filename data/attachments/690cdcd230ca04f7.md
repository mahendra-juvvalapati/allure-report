...
Call log:
  - waiting for locator('[data-testid="mo-toolbar"]').getByRole('button', { name: 'settings' })
    - locator resolved to <button type="button" ng-transclude="" aria-label="settings" ng-click="manageableobject.manageMOQuestionnaire()" class="md-icon-button md-button ng-scope md-ink-ripple" ng-if="canReadQnrSettings && !manageQuestionnaire && show === 'MO questionarrie group tab'">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div class="" x-placement="bottom" id="beamerLastPostTitle">…</div> intercepts pointer events
  ...
  2 × retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <div class=" active" x-placement="bottom" id="beamerLastPostTitle">…</div> intercepts pointer events
      ...
      - generic [ref=e239]:
        - generic [ref=e241]:
          - img [ref=e243]:
            - img
          - generic [ref=e244]:
            - generic [ref=e246]: "Risk: Risk 1778747704609"
