...
Locator: getByRole('option', { name: 'Key Control Indicator (KCI)', exact: true })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('option', { name: 'Key Control Indicator (KCI)', exact: true })
...
- main:
  ...
  - button "Publish"
  - button
  - text: Questionnaire_1780565933515
  - toolbar:
    - tablist:
      - tab "Settings"
      - tab "Questionnaire"
