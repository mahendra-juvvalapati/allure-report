...
Call log:
  - waiting for getByRole('tab', { name: 'Dialogue', exact: true })
    - locator resolved to <md-tab-item role="tab" tabindex="-1" class="md-tab " md-tab-id="1612" id="tab-item-1612" aria-selected="false" aria-disabled="false" md-scope="::tab.parent" md-tabs-template="::tab.label" ng-disabled="tab.scope.disabled" aria-controls="tab-content-1612" ng-repeat="tab in $mdTabsCtrl.tabs" ng-focus="$mdTabsCtrl.hasFocus = true" ng-blur="$mdTabsCtrl.hasFocus = false" md-swipe-left="$mdTabsCtrl.nextPage()" md-swipe-right="$mdTabsCtrl.previousPage()" ng-click="$mdTabsCtrl.select(tab.getIndex())" ng-class="{ '…>…</md-tab-item>
      ...
      - generic [ref=e239]:
        - generic [ref=e241]:
          - img [ref=e243]:
            - img
          - generic [ref=e244]:
            - generic [ref=e246]: "Risk: Risk_1779191343872"
