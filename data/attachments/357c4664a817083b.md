...
Locator: getByRole('option', { name: 'Total', exact: true })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('option', { name: 'Total', exact: true })
...
- main:
  ...
  - button "Publish"
  - button
  - text: Questionnaire_1780072189525
  - toolbar:
    - tablist:
      - tab "Settings"
      - tab "Questionnaire"
    ...
    - tabpanel:
      ...
      - tabpanel:
        - tabpanel:
          ...
          - combobox "Key Risk Indicator (KRI) Type Indicator"
          - text: Type Indicator Development
          - combobox "Development Perspective"
          - text: Perspective Net-Risk
          - combobox "Net-Risk Group"
          - text: Group
          - combobox "Classification" [expanded]
          - text: Classification
          - textbox "KPI / KRI name Long Description"
          - text: KPI / KRI name Long Description
          - textbox "KPI / KRI name Short Description": KRI
          - text: KPI / KRI name Short Description
          - textbox "Code"
          - text: Code
          - textbox "Units"
          - text: Units
          ...
          - combobox "Trend Type"
          - text: Trend Type
          - spinbutton "Trend Margin"
          - text: Trend Margin
          - spinbutton "Decimals"
          - text: Decimals
          - spinbutton "Target Score"
          - text: Target Score
          - textbox "Alarm Score"
          - text: Alarm Score
          - checkbox "KPI can be used in filters and grid"
          - checkbox "HIde this KPI in Key Indicators Tab"
          - checkbox "Show indicator level number" [checked]
      - button
- iframe
```
