...
Call log:
  - waiting for getByRole('button', { name: 'assignment_turned_in' })
    - locator resolved to <button type="button" ng-transclude="" class="md-icon-button md-button md-ink-ripple" ng-class="{'':selected == 'QuestionnairesList'}" ng-click="navbartemplate.navigatePage('questionnaireList')">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div tabindex="-1" aria-hidden="true" class="q-dialog__backdrop fixed-full"></div> from <div class="fic-pluto" id="q-portal--dialog--8">…</div> subtree intercepts pointer events
            ...
            - rowgroup [ref=e291]:
              - row "Type Status Code Questionnaire name Owner Publish status" [ref=e292]:
                ...
                - columnheader "Publish status" [ref=e310] [cursor=pointer]:
                  ...
                  - generic:    
            - rowgroup [ref=e313]:
              - row "Single active Q1 Copy - Questionnaire_1777543711358 mahendra Unpublished" [ref=e314]:
  ...
  - generic:
    - dialog:
      - generic [ref=e461]:
        - generic [ref=e462]:
          - toolbar [ref=e464]:
            - generic [ref=e465]: Add Questionnaire
        ...
        - generic [ref=e473]:
          - toolbar [ref=e475]:
            - tablist [ref=e476]:
              - generic [ref=e477]:
                - tab "New" [selected] [ref=e478] [cursor=pointer]:
                  - generic [ref=e480]: New
                - tab "Template" [ref=e482] [cursor=pointer]:
                  - generic [ref=e484]: Template
          - tabpanel [ref=e488]:
            - tabpanel [ref=e489]:
              - generic [ref=e496]:
                - textbox "Questionnaire name *" [ref=e497]: Questionnaire_1778839839951
                - generic: Questionnaire name *
              - generic [ref=e504]:
                - textbox "Questionnaire code *" [ref=e505]: Q1
                - generic: Questionnaire code *
              - generic [ref=e511] [cursor=pointer]:
                - generic [ref=e512]:
                  - generic [ref=e513]:
                    - generic [ref=e514]: Questionnaire
                    - combobox "Questionnaire Questionnaire type *" [ref=e515]: Questionnaire
                  - generic:
                    - generic: Questionnaire type *
                - generic [ref=e517]: arrow_drop_down
        - generic [ref=e520]:
          - button "Cancel" [ref=e521] [cursor=pointer]:
            - generic [ref=e523]: Cancel
          - button "ADD" [ref=e524] [cursor=pointer]:
            - generic [ref=e526]: ADD
```
