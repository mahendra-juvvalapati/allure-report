...
Locator: getByText('Questionnaire_1780054730771 Link').getByRole('checkbox', { name: 'ql._id' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('Questionnaire_1780054730771 Link').getByRole('checkbox', { name: 'ql._id' })
...
- dialog "wef":
  ...
  - textbox "Enter search": Questionnaire_1780054730771
  - text: search
  - progressbar
  - button "Cancel"
  - button "OK" [disabled]
