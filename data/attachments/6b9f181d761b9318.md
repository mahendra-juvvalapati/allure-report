...
Call log:
  ...
  - waiting for getByTestId('owner').locator('xpath=ancestor::label')
    33 × locator resolved to <label data-v-79990b9b="" for="f_64286603-3212-4fee-b0ac-e809e9b79167" class="q-field row no-wrap items-start q-field--standard q-select q-field--auto-height q-select--with-input q-select--without-chips q-select--single q-field--float q-field--labeled select-cls">…</label>
