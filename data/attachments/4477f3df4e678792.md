...
Locator: getByText('Questionnaire 1780057577537 Link').getByRole('checkbox', { name: 'ql._id' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('Questionnaire 1780057577537 Link').getByRole('checkbox', { name: 'ql._id' })
...
- dialog "wef":
  ...
  - textbox "Enter search": Questionnaire 1780057577537
  - text: search
  - progressbar
  - button "Cancel"
  - button "OK" [disabled]
