...
- Name: E2E_Tests/FC040_questionnaire.spec.ts >> FC_040_Questionnaire Flow >> Configure questionnaire with 'Pages must be completed in order' and verify 'Show' action is executed when Question condition is triggered on 'Entering the questionnaire the first time' and check Questionnaire 'Set quality state to' action
- Location: tests/E2E_Tests/FC040_questionnaire.spec.ts:37:9
