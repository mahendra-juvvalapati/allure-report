...
- main:
  ...
  - button "Publish"
  - button
  - text: Questionnaire 1780055512270
  - toolbar:
    - tablist:
      - tab "Settings"
  ...
  - tabpanel:
    - tabpanel:
      - toolbar:
        - text: (2-2) Matrix question with checkbox
        - combobox "(2-2) Matrix question with checkbox Selected questionnaire page": (2-2) Matrix question with checkbox
        - text: Selected questionnaire page
        - button
      - textbox "Page Title": Matrix question with checkbox
      - text: Page Title
      - checkbox "Disable"
      - alert:
        - button
...
- dialog:
  - toolbar:
    ...
    - button
  - textbox "Answer set name *": Users
  - text: Answer set name *
  - textbox "Description": Add users
