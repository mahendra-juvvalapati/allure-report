...
- main:
  ...
  - tablist "Use the left and right arrow keys to navigate between tabs":
    ...
    - tab "Audits"
  - tabpanel "Dialogue":
    - button "executer Questionnaire 1780316568629 Card image %":
      - img "executer"
      - text: Questionnaire 1780316568629
      - img "Card image"
      - text: "%"
- iframe
- dialog:
  - banner:
    ...
    - listitem:
      ...
      - text: Go to page |
  - main:
    - text: "Risk : Risk 1780316568629 Attributes questions"
    - listitem:
